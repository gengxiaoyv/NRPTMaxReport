...
function nextPage() {
    window.location.href = 'getReport3Page'
}
...
function request(data) {
    ...
    xmlHttp.open("GET","changeTree?keyID="+data.keyID,true);
    xmlHttp.send(null);
...
publick.funAjax('GET','getReportAllData?key=大屏二全部数据',true,data,rseolveData)